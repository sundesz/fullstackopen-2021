...
describe('total likes', () => {
  ...
  test('when list has many blog posts, equals the likes of a total of all blog posts', () => {
...
describe('mostBlogs', () => {
  test('should return author with blog', () => {
    const result = {
      author: 'Robert C. Martin',
      blogs: 3,
    }
...
describe('mostLikes', () => {
  test('should return author with likes', () => {
    const result = {
      author: 'Edsger W. Dijkstra',
      likes: 17,
    }
